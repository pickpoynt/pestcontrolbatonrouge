                        ...
                        <div className="bg-white rounded-[2rem] p-8 shadow-xl border border-slate-100 flex flex-col justify-between">
                            <div>
                                ...
                                <p className="text-slate-600 text-sm leading-relaxed italic mb-8">
                                    To get started, simply email us at the address below. We'll confirm availability, swap in your number, and have you receiving toxic black mold cleanup calls within 24 hours.
                                </p>
                            </div>
